...
-- -----------------------------------------------------
-- Table `inf226g1`.`pedido_parcial_x_item_producto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inf226g1`.`pedido_parcial_x_item_producto` ;

CREATE TABLE IF NOT EXISTS `inf226g1`.`pedido_parcial_x_item_producto` (
