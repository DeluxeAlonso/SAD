...
-- Schema saddb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `saddb` DEFAULT CHARACTER SET utf8 ;
USE `saddb` ;
...
CREATE TABLE IF NOT EXISTS `saddb`.`pallet` (
  ...
  CONSTRAINT `fk_pallet_item_producto1`
    ...
    REFERENCES `saddb`.`item_producto` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `saddb`.`orden_internamiento_x_item_producto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `saddb`.`orden_internamiento_x_item_producto` ;

CREATE TABLE IF NOT EXISTS `saddb`.`orden_internamiento_x_item_producto` (
...
-- -----------------------------------------------------
-- Table `saddb`.`pedido_parcial_has_item_producto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `saddb`.`pedido_parcial_has_item_producto` ;

CREATE TABLE IF NOT EXISTS `saddb`.`pedido_parcial_has_item_producto` (
