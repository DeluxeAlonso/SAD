...
-- -----------------------------------------------------
-- Table `saddb`.`pedido_parcial_x_item_producto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `saddb`.`pedido_parcial_x_item_producto` ;

CREATE TABLE IF NOT EXISTS `saddb`.`pedido_parcial_x_item_producto` (
  `id_pedido_parcial` INT(11) NOT NULL,
  `id_item_producto` INT(11) NOT NULL,
  PRIMARY KEY (`id_pedido_parcial`, `id_item_producto`),
  INDEX `fk_pedido_parcial_has_item_producto_item_producto1_idx` (`id_item_producto` ASC),
  INDEX `fk_pedido_parcial_has_item_producto_pedido_parcial1_idx` (`id_pedido_parcial` ASC),
